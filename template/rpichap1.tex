...
The University of Virginia demonstrates the ability to achieve a unified library system using a combination of XML and web service technologies of their disparate assemblage of libraries .
...
This becomes particularly relevant as innovations in computation technology generates small, volatile data sets to integrate into larger data managers 
...
The ATLAS project at CERN reports that it generates on the order of four thousand new datasets per day from experimental tests alone shown in Table \ref{table:Atlas} .
...
\begin{figure}
	...
	\caption[Summary of ASDC Holdings for the years 2001 to 2004.]{Summary of ASDC Holdings for the years 2001 to 2004.  From Barkstrom and Bates \cite{Barkstrom_digitallibrary}}
	\label{table:ASDC}
\end{figure}
...
\begin{table}
	...
	\begin{tabular}{ | c | c |}
		...
		\hline
	\end{tabular}
	\caption[Summary of ATLAS data set generation in 2008]{Summary of ATLAS data set generation in 2008.  From Branco et al.\cite{Branco2008}}
	\label{table:Atlas}
\end{table}
