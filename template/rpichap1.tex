...
Through the process of addressing Use Case 1, I develop my first contribution, the idea of a versioning graph.
...
The versioning graph enables my second contribution, a process to automate machine-readable change log creation.
...
My third contribution is using a versioning graph to provide a quantitative basis for determining change distance.
