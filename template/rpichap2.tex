...
PAV covers the case where new versions do not have to be substantive but can still be alternate editions of the original object
...
A version is something that cannot be considered an entirely different or new work. --> Business layer Duerr
